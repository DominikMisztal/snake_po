...
private:
  ...
  void generateFood(){
    CPoint spot;
    while(true){
      spot = CPoint( (rand() % (geom.size.x - 3)) + 2, (rand() % (geom.size.y -3 )) + 2);
